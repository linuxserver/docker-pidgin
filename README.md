...
[![MicroBadger Layers](https://img.shields.io/microbadger/layers/linuxserver/pidgin.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge)](https://microbadger.com/images/linuxserver/pidgin "Get your own version badge on microbadger.com")
...
* Shell access whilst the container is running: `docker exec -it pidgin /bin/bash`
* To monitor the logs of the container in realtime: `docker logs -f pidgin`
...
* Update all images: `docker-compose pull`
  * or update a single image: `docker-compose pull pidgin`
* Let compose update all containers as necessary: `docker-compose up -d`
  * or update a single container: `docker-compose up -d pidgin`
* You can also remove the old dangling images: `docker image prune`

### Via Docker Run

* Update the image: `docker pull ghcr.io/linuxserver/pidgin`
* Stop the running container: `docker stop pidgin`
* Delete the container: `docker rm pidgin`
